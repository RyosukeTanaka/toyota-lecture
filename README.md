...
### 予測分析ページ
1.  **保存済みモデル選択:**
    *   ローカルに保存された学習済みモデルから、予測に使用するモデルを選択します。
    *   選択したモデルの基本情報（名前、タイプ、作成日）や性能指標が表示されます。
2.  **実績データの可視化:**
...
5.  サイドバー上部のラジオボタンで「モデルトレーニング」、「予測分析」または「データ分析・修正」を選択します。
